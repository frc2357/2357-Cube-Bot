package com.swervelib.simulation.ctre;

import com.ctre.phoenix.motorcontrol.can.VictorSPX;
import com.swervelib.simulation.ctre.PhysicsSim.SimProfile;
...
class VictorSPXSimProfile extends SimProfile
{
  ...
  public void run()
  {
    ...
    _victor.getSimCollection().setBusVoltage(12 - outPerc * outPerc * 3 / 4 * PhysicsSim.random(0.95, 1.05));
  }
}
