...
public class TrajectoryUtil {
	...
	public static SequentialCommandGroup createDrivePathCommand(
		...
		SwerveDriveSubsystem swerveDrive = Robot.drive;
		...
		pathCommand.addCommands(new InstantCommand(() -> {
			...
			Constants.SWERVE.TRAJECTORY_X_CONTROLLER.reset();
			Constants.SWERVE.TRAJECTORY_Y_CONTROLLER.reset();
		...
		pathCommand.addCommands(new PPSwerveControllerCommand(
				...
				Constants.SWERVE.TRAJECTORY_X_CONTROLLER,
				Constants.SWERVE.TRAJECTORY_Y_CONTROLLER,
				Constants.SWERVE.TRAJECTORY_THETA_CONTROLLER,
				(SwerveModuleState[] moduleStates) -> {
					swerveDrive.setChassisSpeeds(swerveDrive.getKinematics().toChassisSpeeds(moduleStates));
				}, true));
